...
def test_replace_not_longer(blockchain_three_blocks):
    blockchain = Blockchain()
...
def test_is_valid_transaction_chain_duplication_transactions(blockchain_three_blocks):
    transaction = Transaction(Wallet(), 'recipeint', 1).to_json()
